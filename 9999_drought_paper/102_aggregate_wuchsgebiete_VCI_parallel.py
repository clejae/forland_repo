...
out_pth = r'_temp\\00_MA\data\vector\lsp_metrics\wuchsgebiete\VPI_2018_wuchsgebiete_BL_2008-2018.csv'
...
for i in range(feat_count):
    ...
    vrt_msk_pth = r'Z:\germany-drought\vrt\wuchsgebiete\{1}_{0}_MASK_FOREST-BROADLEAF.vrt'.format(wuchs_name,
                                                                                                  wuchs_id)
    ...
    file_lst = [
        r'Z:\germany-drought\VCI_VPI\{0}\2018_BL-2008-2018_VPI.tif'.format(t)
        for t in tiles_lst]
    vrt_ind_pth = r'_temp\00_MA\data\vrt\wuchsgebiete\VPI\{1}_{0}_VPI_2018_BL-2008-2018.vrt'.format(
        wuchs_name,wuchs_id)
