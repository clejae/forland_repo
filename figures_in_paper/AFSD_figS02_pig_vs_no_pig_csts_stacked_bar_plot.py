...
out_pth = r"figures\in_paper\AFSD_FigPigs.tif"
...
name_lst = ["Without hogs","With hogs"]
...
ncol = 2
nrow = 1
fig, axs = plt.subplots(nrows=nrow, ncols=ncol, sharey=True, figsize=cm2inch(17.6, 8))
...
for strat in strata_cattle:
    ...
    ## Prepare data frame
    df_descr = 'CSTArea-PigNumbers_binary'
