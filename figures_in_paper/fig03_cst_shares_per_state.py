...
out_pth = r"figures\plots\cst_areas\SA+BB+BV+LS_CSTAreas-2012-2018.png"
...
ax.set_yticks(np.arange(0, 36, step=5))
ax.set_yticklabels(range(0, 36, 5), fontdict={'size': 10})
...
## label y axis
ax.set_xlabel('Structural types per federal state', fontdict={'size': 10})
