...
min_year = 2012
max_year = 2018
range_lst = [(2005,2008),(2006,2009),(2007,2010),(2008,2011),(2009,2012),(2010,2013),(2011,2014),(2012,2015),(2013,2016),
             (2014,2017),(2015,2018)]
for year_tuple in range_lst:
    min_year = year_tuple[0]
    max_year = year_tuple[1]
    ...
    def workFunc(tile):
        ...
        arr_mt = np.apply_along_axis(func1d=identifyMainTypes, axis=0, arr=arr, no_data_value = 255, arable_grass_value = 13, skip_lst = [30, 70, 80, 99])
