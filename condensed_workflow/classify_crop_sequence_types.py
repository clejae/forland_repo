...
## ToDo: Diese Ordner auf jeden Fall erstellen "grid_15km"
...
def main():
    ...
    tiles_lst = ["0022_0024"]
    joblib.Parallel(n_jobs=1)(joblib.delayed(stack_rasters)(tile) for tile in tiles_lst)
    joblib.Parallel(n_jobs=1)(joblib.delayed(determine_crop_sequence_types)(tile) for tile in tiles_lst)
...
# file_list = glob.glob(r'Q:\FORLand\Clemens\data\raster\grid_15km\**\TH_2013-2019_CropSeqType.tif')
# vrt = gdal.BuildVRT(r'Q:\FORLand\Clemens\data\raster\mosaics\crop sequence types\TH_2013-2019_CropSeqType.vrt', file_list)
# del(vrt)
# ras_cut = gdal.Translate(r'Q:\FORLand\Clemens\data\raster\mosaics\crop sequence types\TH_2013-2019_CropSeqType.tif', vrt, creationOptions = ['COMPRESS=LZW'])